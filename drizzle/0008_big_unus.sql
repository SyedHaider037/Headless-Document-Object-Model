CREATE TABLE "global_permissions" (
	...
	CONSTRAINT "global_permissions_action_unique" UNIQUE("action")
);
...
ALTER TABLE "roles_Permissions" ADD CONSTRAINT "roles_Permissions_permissionId_global_permissions_id_fk" FOREIGN KEY ("permissionId") REFERENCES "public"."global_permissions"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
